...
// .wrangler/tmp/bundle-2VqWjV/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-w1apbV/bundledWorker-0.9321140302648939.mjs
...
__name2(pickWeatherLine, "pickWeatherLine");
...
__name2(callImageModel, "callImageModel");
...
__name2(weatherCodeText, "weatherCodeText");
...
__name2(weatherCodeTextEn, "weatherCodeTextEn");
...
__name2(weatherCodeIcon, "weatherCodeIcon");
...
__name2(getRealtimeWeather, "getRealtimeWeather");
...
__name2(buildImagePromptStrict, "buildImagePromptStrict");
function wrapWithHeaderSVG(pngDataUri, enHeader) {
  const w = 1280, h = 720, headH = 88;
  const bg = "#ffffff";
  const text = "#111";
  const esc = /* @__PURE__ */ __name2((s) => String(s || "").replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;"), "esc");
...
__name2(wrapWithHeaderSVG, "wrapWithHeaderSVG");
...
__name2(svgImageStrict, "svgImageStrict");
var worker_default = {
...
// .wrangler/tmp/bundle-2VqWjV/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-2VqWjV/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.9321140302648939.js.map
